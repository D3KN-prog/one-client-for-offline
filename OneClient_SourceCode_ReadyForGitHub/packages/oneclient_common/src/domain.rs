...
impl ContentType {
    ...
    pub fn disabled_folder_name(self) -> &'static str {
        match self {
            Self::Mod => "disabled-mods",
            Self::ResourcePack => "disabled-resourcepacks",
            Self::Shader => "disabled-shaderpacks",
            Self::DataPack => "disabled-datapacks",
            Self::World => "disabled-worlds",
            Self::Modpack => "disabled-modpacks",
        }
    }

    pub fn from_folder_name(name: &str) -> Option<Self> {
        match name.to_lowercase().as_str() {
            "mods" | "mod" | "disabled-mods" | "disabled_mods" | "disabled mods" => Some(Self::Mod),
