...
pub fn use_art_bytes(
    ...
    let default_asset = match major {
        Some(21) => "backgrounds/TrickyTrials.jpg",
        Some(20) => "backgrounds/TrailsAndTales.jpg",
        Some(19) => "backgrounds/TheWildUpdate.jpg",
        Some(16) => "backgrounds/NetherUpdate.jpg",
        _ => HOME_BACKGROUND_ASSET,
    };
    let fallback = use_memo(move || AppAssets::get_bytes(default_asset).unwrap_or_default());
