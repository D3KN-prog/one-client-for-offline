    ...
    rect()
        ...
        .child(
            rect()
                ...
                .background(Color::from_argb(180, 20, 30, 45))
                .border(crate::ui::border_all_color(1., Color::from_argb(120, 100, 160, 255)))
                .child(
                    label()
                        .text("Edited by D3KN")
                        .font_size(11.)
                        .font_weight(FontWeight::BOLD)
                        .color(Color::from_rgb(140, 200, 255)),
                ),
        )
}
...
fn navbar_center() -> impl IntoElement {
    ...
    rect()
        ...
        .child(NavLink {
            ...
            nav_label: "Instances",
            badge: 3, // We will fake +3 as requested for now to show off the UI
        })
        .child(NavLink {
        ...
        rect()
            ...
            .child(
                rect()
                    ...
                    .maybe_child((badge > 0).then(|| {
                        rect()
                            .padding(Gaps::new_symmetric(0., 4.))
                            .corner_radius(CornerRadius::from(6.))
                            .background(theme::colors::brand())
                            .center()
                            .child(
                                label()
                                    .text(format!("+{badge}"))
                                    .font_family(theme::PIXEL_FONT)
                                    .font_size(9.)
                                    .color(theme::colors::fg_primary()),
                            )
                            .into_element()
...
impl Component for NavbarRight {
    fn render(&self) -> impl IntoElement {
        ...
        rect()
            ...
            .child(
                super::navbar_button()
                    .child(Icon::new(IconType::DownloadCloud02).size(20.))
                    .on_press(open_notifications.clone()),
            )
            .child(
                super::navbar_button()
