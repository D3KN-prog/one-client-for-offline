        ...
        let mut content = rect()
            ...
            .child(
                rect()
                    ...
                    .child(
                        label()
                            .text("Choose a folder location for PulseClient")
                            .font_size(26.)
                    ...
                    .child(
                        label()
                            .text(
                                "Any content downloaded via PulseClient (such as Minecraft versions, mods, your worlds) will go in this folder. Make sure you have sufficient storage in your chosen disk.",
                            )
                            .font_size(14.)
...
fn browse(
    ...
    spawn(async move {
        let Some(handle) = rfd::AsyncFileDialog::new()
            .set_title("Choose where PulseClient stores game data")
            .pick_folder()
            .await
        else {
            return;
