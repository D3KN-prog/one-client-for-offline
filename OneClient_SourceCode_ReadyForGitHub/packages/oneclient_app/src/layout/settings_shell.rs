...
const SEARCH_INDEX: &[SearchItem] = &[
    ...
    SearchItem {
        ...
        description: "Override the default PulseClient backend endpoint.",
    ...
    SearchItem {
        ...
        icon: IconType::Database01,
        title: "Disk usage",
        description: "See what the launcher is storing and where.",
        keywords: &["storage", "disk", "space", "size", "usage", "cache"],
    ...
    SearchItem {
        ...
        title: "Changelog",
        description: "View what's new in PulseClient.",
