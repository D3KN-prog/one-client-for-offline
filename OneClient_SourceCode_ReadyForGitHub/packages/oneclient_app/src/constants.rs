...
pub const WINDOW_TITLE: &str = "PulseClient • Edited by D3KN";
...
pub const UPDATER_ENDPOINT: &str = "https://github.com/Polyfrost/OneLauncher/releases/latest/download/latest.json";
