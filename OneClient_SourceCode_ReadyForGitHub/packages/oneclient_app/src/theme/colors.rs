...
pub fn fg_primary() -> Color {
    Color::from_rgb(230, 236, 255)
}

pub fn fg_primary_hover() -> Color {
    Color::from_rgb(245, 248, 255)
}
...
pub fn fg_primary_disabled() -> Color {
    Color::from_rgb(145, 153, 172)
}

pub fn fg_secondary() -> Color {
    Color::from_rgb(175, 188, 205)
}

pub fn fg_secondary_hover() -> Color {
    Color::from_rgb(215, 226, 240)
}

pub fn fg_secondary_pressed() -> Color {
    Color::from_rgb(235, 242, 255)
}

pub fn brand() -> Color {
    Color::from_rgb(0, 200, 255)
}
